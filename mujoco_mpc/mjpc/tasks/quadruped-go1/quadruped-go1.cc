...
#include "mjpc/tasks/quadruped-go1/quadruped-go1.h"
...
std::string QuadrupedGo1Hill::Name() const { return "Go1 Hill"; }
std::string QuadrupedGo1Flat::Name() const { return "Go1 Flat"; }
