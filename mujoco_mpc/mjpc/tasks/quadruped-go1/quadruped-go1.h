...
class QuadrupedGo1Flat : public Task {
 public:
 ...
 private:
  ...
  //  ============  constants  ============
  constexpr static Go1Foot kFootAll[kNumFoot] = {kFootFL, kFootHL,
                                                kFootFR, kFootHR};
  constexpr static Go1Foot kFootHind[2] = {kFootHL, kFootHR};
  constexpr static Go1Gait kGaitAll[kNumGait] = {kGaitStand, kGaitWalk,
...
class QuadrupedGo1Hill : public Task {
 public:
  std::string Name() const override;
  std::string XmlPath() const override;
